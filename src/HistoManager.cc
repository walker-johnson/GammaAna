...
void HistoManager::Book()
{
  ...
  analysisManager->CreateNtuple("nFlux_slab", "Neutrons leaving the concrete slab"); //id = 2
  analysisManager->CreateNtupleDColumn("x");
  analysisManager->CreateNtupleDColumn("y");
  analysisManager->CreateNtupleDColumn("z");
  analysisManager->CreateNtupleDColumn("KE");
  ...
  analysisManager->CreateNtuple("gFlux_slab", "Gammas leaving the concrete slab"); //id = 3
  analysisManager->CreateNtupleDColumn("x");
  analysisManager->CreateNtupleDColumn("y");
  analysisManager->CreateNtupleDColumn("z");
  analysisManager->CreateNtupleDColumn("E");
  ...
  // ID = 4, gammas entering detector from lead
  analysisManager->CreateNtuple("gDetector_bkg", "Gammas entering detector from lead shield"); //id = 4
  analysisManager->CreateNtupleDColumn("x");
  analysisManager->CreateNtupleDColumn("y");
  analysisManager->CreateNtupleDColumn("z");
  analysisManager->CreateNtupleDColumn("E");
  ...
  // ID = 5, gammas entering detector from poly
  analysisManager->CreateNtuple("gDetector", "Gammas entering detector from polyethylene"); //id = 5
  analysisManager->CreateNtupleDColumn("x");
  analysisManager->CreateNtupleDColumn("y");
  analysisManager->CreateNtupleDColumn("z");
  analysisManager->CreateNtupleDColumn("E");
